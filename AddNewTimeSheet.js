        ...
        <div className="header-background ">
         ...
         {/*Time sheet code table */}
           <TimeSheetCodeTable/>
             ...
             <div style={{marginTop:"50px",marginRight:"30pc"}}>
             <Row  >
                 <Col >
                 <div style={{
                               display: "flex",
                    ...
                    <span>  <h5 style={{marginTop:"15px",marginRight:"20px"}} >Total:</h5> </span>
                     <TextField
                      id="total"
                      placeholder="hh:mm" 
                      style={{width:"8pc"}}
             ...
             <Row>
                 ...
                 <div style={{ display: "flex",
                     ...
                     <span>  <h5 style={{marginTop:"15px",marginRight:"20px"}} >Excess/Shortage:</h5> </span> 
                     <TextField
                      id="Excess"
                      placeholder="hh:mm" 
                      style={{width:"8pc"}}
             ...
             <Row>
               ...
               <button style={{width:"100px",borderRadius:"20px",outline:"none"}} type="button"  class="btn btn-primary">Save</button>
               </Col>
               </Row>
